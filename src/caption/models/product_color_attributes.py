...
from .base_types import PrimaryColor, Brightness, Saturation
...
class ColorAttribute(BaseModel):
    ...
    brightness: Annotated[
        Brightness, Field(..., description='색상의 명도 특성을 선택', examples=['아주 밝음', '밝음', '중간 밝기', '어두움', '아주 어두움'])
    ]
    saturation: Annotated[
        Saturation, Field(..., description='색상의 채도 특성을 선택', examples=['아주 낮음', '낮음', '중간 채도', '높음', '아주 높음'])
    ]
