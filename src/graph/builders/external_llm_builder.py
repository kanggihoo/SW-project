...
from graph.common.nodes.search_node import run_expert_evaluation_node
from graph.common.state import State
from graph.constants import NodeName


def build_external_llm_graph() -> CompiledStateGraph:
    """Combined external LLM and search graph builder
    ...
    graph_builder.add_edge(START, NodeName.RUN_EXPERT_EVALUATION)
    graph_builder.add_edge(NodeName.RUN_EXPERT_EVALUATION, END)

    compiled_graph = graph_builder.compile()
    compiled_graph.name = 'external_llm'
