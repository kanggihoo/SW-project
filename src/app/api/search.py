...
from app.config.dependencies import  SearchServiceTestDep
...
@router.get("/{product_id}", response_model=SearchResponse)
async def search_product(
    search_service: SearchServiceTestDep,
    product_id: Annotated[int, Path(description="조회할 상품 sku_id", example="3522389_블랙")]
):
    pass