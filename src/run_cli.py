...
from graph.settings import DatabaseType, MonitoringType
...
@app.command()
def main(
    database_type: Annotated[DatabaseType, typer.Option('--database-type', '-db', help='Database type')] = DatabaseType.SQLITE,
