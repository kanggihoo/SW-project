...
**분석 방법:**
1. 누끼 이미지들로 부터 {category}에 대한 구조적 디테일과 디자인 요소 파악
2. 모델 착용 이미지로부터 {category}의 핏, 스타일, TPO(time, place, occasion) 정보 분석
3. 주어진 이미지에 대해 json 형식으로 구조적 디테일과 디자인 요소 파악

**구조적 속성:**
- 공통: {category}가 "상의"인 경우에는 넥라인, 소매길이 정보 , "하의"인 경우에는 기장 정보 
- 정면: 패턴, 여밈/장식 요소 
- 후면: 패턴, 여밈/장식 요소

**주관적 속성:**
- 핏 타입 (단일 선택) : {category}에 따라 선택해야 하는 핏 타입 정보가 다르니 주의 
