        ...
        try:
                ...
                if len(docs) >= batch_size:
                    ...
                    if result and result.get('success', False):
                        ...
                        local_update_result = local.bulk_update_documents(
                            session=None, document_ids=batch_ids, update_data={'data_status': 'CL_COMP'}
                        )
            ...
            if docs:
                ...
                if result and result.get('success', False):
                    ...
                    local_update_result = local.bulk_update_documents(session=None, document_ids=batch_ids, update_data={'data_status': 'CL_COMP'})
