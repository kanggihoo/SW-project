...
def sample_data():
    ...
    d['deep_caption'] = {
        ...
        'structured_attributes': {
            'common': {'sleeve_length': '긴소매', 'neckline': '라운드넥'},
            'front': {
                'closures_and_embellishments': {'description': '정면 중앙에 별도의 여밈이나 장식 요소 없음', 'type': '여밈 없음'},
                'pattern': {'description': '정면은 무지 디자인', 'type': '무지/솔리드'},
            },
            'back': {
                'closures_and_embellishments': {'description': '후면에 텍스트 레터링 있음', 'type': '여밈 없음'},
                'pattern': {'description': '후면에 텍스트 레터링', 'type': '타이포그래피/레터링'},
            },
            'subjective': {'fit': '레귤러 핏/스탠다드 핏', 'style_tags': ['모던/미니멀', '캐주얼'], 'tpo_tags': ['데일리', '데이트/주말']},
        },
    }

    d['color_images'] = {
        'color_info': [
            {'name': '블랙', 'attributes': {'saturation': '아주 낮음', 'brightness': '아주 어두움'}, 'hex': '#000000'},
            {'name': '화이트', 'attributes': {'saturation': '아주 낮음', 'brightness': '아주 어두움'}, 'hex': '#000000'},
        ]
    }
    d['text_images'] = {
        'size_info': {
