...
async def main():
    ...
    parser_add = subparsers.add_parser(
        "add_bson", 
        help="Convert a vector field to BSON format and add it as a new field.",
        formatter_class=argparse.RawTextHelpFormatter
    )
    ...
    parser_remove = subparsers.add_parser(
        "remove_field", 
        help="Remove a specific field from all documents in the collection.",
        formatter_class=argparse.RawTextHelpFormatter
    )
