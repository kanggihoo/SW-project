...
class ProductMetaManager:
    ...
    def __init__(self, config:Config):
        ...
        self.all_possible_statuses = ['CR_DET', 'IMG_DOWN', 'AWS_UPL', 'RE_COMP', 'CA_COMP', 'EM_COMP']
    ...
    def show_terminal(self):
        ...
        },
        {
            "$group": {
                ...
                "EMB_COMP": {
                    "$sum": {
                        "$cond": [{ "$eq": ["$status_breakdown.status", "EMB_COMP"] }, "$status_breakdown.count", 0]
                    }
                },
        ...
        df = df[['main_category', 'sub_category', 'CR_DET', 'AWS_UPL', 'RE_COMP', 'CA_COMP', 'EMB_COMP', 'total_count']]
