...
@router.get("/products/{product_id}/brand-price",
...
@router.get("/products/{product_id}/size-details",
...
@router.get("/products/{product_id}/size-recommend",
...
@router.get("/products/{product_id}/other-colors",
...
@router.get("/products/{product_id}/selection-info",
...
@router.get("/products/{product_id}/option-stock",
...
@router.get("/products/{product_id}/reviews/count",
...
async def get_review_list(
    ...
    sort: Annotated[Literal["up_cnt_desc", "new", "comment_cnt_desc", "goods_est_desc", "goods_est_asc"], Query(description="정렬 순서: 유용도순, 최신순, 댓글순, 평점높은순, 평점낮은순")] = "up_cnt_desc",
...
async def get_brand_likes_count(
    wrapper: MusinsaAPIWrapperDep,
    payload: Annotated[m.BrandLikesCountRequest, Body()]
):
